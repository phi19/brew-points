...
const PurchaseScreen = props => {
  ...
  const entryPromoCardModalKeyboardAvoidingViewPromoCodePopUpTextInputRef =
    React.useRef();
          ...
          <Button
            ...
            onPress={() => {
              try {
                ...
                entryPromoCardModalKeyboardAvoidingViewPromoCodePopUpTextInputRef.current.focus();
              } catch (err) {
                console.error(err);
              }
            }}
            ...
            >
              ...
              >
                ...
                <TextInput
                  ...
                  ref={
                    entryPromoCardModalKeyboardAvoidingViewPromoCodePopUpTextInputRef
                  }
                  style={StyleSheet.applyWidth(
                    StyleSheet.compose(
                  ...
                  >
                    ...
                    >
                      ...
                      <RadioButton
                        ...
                        color={palettes.App['Custom Color_3']}
                        selectedIcon={'Ionicons/checkmark-circle-sharp'}
...
export default withTheme(PurchaseScreen);
